...
def run_ai_analysis(top_stocks, client):
    ...
    prompt = (
        ...
        f"You have scored {len(top_stocks)} stocks. Select the BEST 10-12 for a growth portfolio.\n\n"
        f"Scoring data:\n{stocks_summary}\n\n"
        "Select 10-12 stocks, assign allocation % totalling 100%, 1-line bull/bear per stock.\n"
        "Give portfolio a name and overall thesis.\n\n"
        "Respond ONLY with valid JSON:\n{\n"
        '  "portfolio_name": "...",\n  "overall_thesis": "...",\n'
        f'  "date": "{date_str}",\n'
        '  "stocks": [{"ticker":"AAPL","name":"Apple","sector":"Technology",'
        '"allocation_pct":10,"score":78,"bull_case":"...","bear_risk":"...",'
        '"analyst_target":230,"current_price":195}]\n}'
    )
